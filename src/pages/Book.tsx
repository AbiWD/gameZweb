...
export default function Book({ setRoute }: BookProps) {
  ...
  const handleConfirmReservation = () => {
    ...
    // Create a finalized booking object in global context (supports overlapping protection)
    const bookingData = {
      customerName,
      customerEmail,
      customerPhone,
    ...
    if (res.success && res.booking) {
      ...
      alert(`Collision Error: ${res.error || 'Failed to complete booking.'}`);
      setStep(2); // kick back to slot selection
    }
  };
